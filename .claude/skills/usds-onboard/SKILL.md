---
name: usds-onboard
description: 【共享】入职演练 — 五步协作法、代理分工、目录规范 → 协议摘要。当用户说「入职/怎么协作」时使用。
context: fork
agent: delivery-manager
---

# 技能：新人入职引导 (/usds-onboard)
...
4.  **实操演练**: 引导成员运行一个简单的 `/studio-discovery` 体验全生命周期。
...
建议从 `/studio-discovery` 或 `/studio-project-scan` 开始第一个实际任务。
```
