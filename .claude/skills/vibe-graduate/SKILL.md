---
name: vibe-graduate
description: 【Vibe→Studio】原型晋升 — 将 sandbox 原型迁入 src/ 并补齐 ADR/测试/规范 → 生产代码。当用户说「原型稳了/转正」时使用。
context: fork
agent: delivery-manager
---

# 技能：原型晋升 (/vibe-graduate)
...
- 后续：进入常规 Studio Mode 流程（`/studio-sprint-kickoff` / `/studio-review` / `/studio-gate-check`）
