---
name: vibe-taste-review
description: 【Vibe】审美评审 — 视觉/交互氛围评价 → docs/reviews/taste-<date>.md。当用户说「不好看/感觉不对劲」且原型已可跑时使用。
context: fork
agent: stylist
---
...
`/studio-review` 关心代码质量，`/studio-gate-check` 关心工程合规——都无法评审**审美**。
...
- 评审后"推翻重来" → `/vibe-branch` 分叉新方向 或 `/vibe-start` 重启
- 评审通过 → 可考虑 `/vibe-graduate` 晋升
