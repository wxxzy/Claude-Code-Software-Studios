---
name: studio-setup-stack
description: 【Studio】技术选型与骨架 — 选定技术栈、生成脚手架与依赖文件 → 项目骨架。当用户说「搭架子/初始化项目」时使用。
context: fork
agent: technical-architect
---

# 技能：技术栈初始化 (/studio-setup-stack)
...
- 完成后，交棒 `delivery-manager` 执行 `/studio-sprint-kickoff`。
