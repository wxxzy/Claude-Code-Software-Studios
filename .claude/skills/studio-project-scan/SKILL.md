---
name: studio-project-scan
description: 【Studio】代码库扫描 — 映射既有项目、识别技术债 → docs/arch/SYSTEM-MAP.md + TECH-DEBT.md。当用户说「分析这个项目/代码库现状」时使用。
context: fork
agent: technical-architect
---

# 技能：项目扫描与映射 (/studio-project-scan)
