...
description: 【Studio】需求发现 — 把模糊想法转化为 PRD → docs/specs/PRD.md。当用户说「有个项目想法/写份需求文档」时使用。
context: fork
agent: product-director
---

# 技能：需求发现 (/studio-discovery)
...
- PRD 批准后，交棒 `technical-architect` 执行 `/studio-arch-design`。
