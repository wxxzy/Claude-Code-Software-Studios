---
name: studio-sprint-kickoff
description: 【Studio】冲刺启动 — 把设计拆解为可执行任务 → production/backlog.md。当用户说「拆任务/开个冲刺」时使用。
context: fork
agent: delivery-manager
---

# 技能：冲刺启动 (/studio-sprint-kickoff)
...
1.  **启动**: 用户输入 `/studio-sprint-kickoff [架构文档路径]`。
